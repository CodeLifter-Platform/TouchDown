...
namespace TD.Migrations
{
    ...
    [Migration("20260726231157_ConsolidatePlaybookSeed")]
    partial class ConsolidatePlaybookSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TD.Models.AgentMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Name = "The Safety",
                            Role = 2,
                            SystemPrompt = "You are the Safety — the code reviewer. You review all output from the Offensive Line and the Defensive Line before it merges. Check for bugs, security issues, code quality, test coverage, and adherence to the plan."
                        },
                        new
                        {
                            Id = 5,
                        ...
                        new
                        {
                            ...
                            Name = "Special Teams",
                            Role = 4,
                            SystemPrompt = "You are Special Teams — handling CI/CD, infrastructure, and build pipeline work. You activate when the play involves DevOps tasks."
                        },
                        new
                        {
                            Id = 8,
            ...
            modelBuilder.Entity("TD.Models.CommunicationRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentTeamId = 1,
                            Description = "Quarterback reads the task, huddles with the user, then snaps. The Scout researches when needed. The Offensive Line and the Defensive Line each run multiple instances in parallel. Safety reviews before merge.",
                            Style = 1
                        });
                });
